...
export default function CopyToClipboard({ joinLink }: CopyProps): ReactElement {
  const [copyText, setCopyText] = useState(joinLink)
    ...
    <div className="text-center font-bold">
      ...
      <div className="lobby-input flex flex-row justify-center">
        <div className="copy flex flex-row">
          ...
          >
            <input
              className="bg-blue-10 text-center rounded-lg border-none"
              type="text"
              value={copyText}
              readOnly
            />
